        ...
        <CardContent className="p-3 lg:p-6 w-full">
          <div className="w-full overflow-x-auto">
            <table className="border-collapse text-xs lg:text-sm w-full min-w-[800px]">
              <thead>
                <tr>
                  <th className="border border-gray-300 px-1 lg:px-2 py-2 text-xs lg:text-sm font-medium text-center bg-white sticky left-0 z-10 md:static min-w-[80px] lg:min-w-[100px]"></th>
