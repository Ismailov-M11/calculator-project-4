    ...
    switch (language) {
      case "ru":
        return {
          ...
          rates: [
            "��т 1 кг до 99 кг – каждый килограмм по 5000 сум",
            "от 100 кг до 499 кг – каждый килограмм по 4000 сум",
            "от 500 кг ��о 1500 кг – каждый килограмм по 3000 сум",
          ],
        };
      case "uz":
        return {
      ...
      default:
        return {
          ...
          rates: [
            ...
            "от 100 кг до 499 кг – каждый килограмм по 4000 сум",
            "от 500 кг до 1500 кг – каждый килограмм ��о 3000 сум",
          ],
        };
    }
  };
      ...
      case "ru":
        return {
          ...
          notes: [
            ...
            "Есл�� при вызове курьера Отправитель откажется передавать Отправление к доставке, Заказчик должен оплатить за ложный вызов курьера 25 000 сум без НДС (28 000 с НДС)",
          ],
